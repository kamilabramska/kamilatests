...
public class DataElementDaily {
    ...
    public void setTemperatureHighTime(Date temperatureHighTime) {
    ...
    public void setTemperatureLowTime(Date temperatureLowTime) {
    ...
    public void setApparentTemperatureHighTime(Date apparentTemperatureHighTime) {
    ...
    public void setApparentTemperatureLowTime(Date apparentTemperatureLowTime) {
    ...
    public void setUvIndexTime(Date uvIndexTime) {
